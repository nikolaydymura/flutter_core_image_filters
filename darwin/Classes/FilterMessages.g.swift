...
private class FilterMessagesPigeonCodecReader: FlutterStandardReader {
}

private class FilterMessagesPigeonCodecWriter: FlutterStandardWriter {
}

private class FilterMessagesPigeonCodecReaderWriter: FlutterStandardReaderWriter {
  override func reader(with data: Data) -> FlutterStandardReader {
    return FilterMessagesPigeonCodecReader(data: data)
  }

  override func writer(with data: NSMutableData) -> FlutterStandardWriter {
    return FilterMessagesPigeonCodecWriter(data: data)
  }
}

class FilterMessagesPigeonCodec: FlutterStandardMessageCodec, @unchecked Sendable {
  static let shared = FilterMessagesPigeonCodec(readerWriter: FilterMessagesPigeonCodecReaderWriter())
}
...
class FilterApiSetup {
  static var codec: FlutterStandardMessageCodec { FilterMessagesPigeonCodec.shared }
  /// Sets up an instance of `FilterApi` to handle messages through the `binaryMessenger`.
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: FilterApi?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let createChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.create\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let exportDataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.exportData\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let exportImageFileChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.exportImageFile\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let exportVideoFileChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.exportVideoFile\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setInputDataChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setInputData\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setInputDataChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let filterIdArg = args[0] as! Int64
    ...
    let setInputAssetChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setInputAsset\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setInputFileChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setInputFile\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setNSNumberParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setNSNumberParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setCIColorParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setCIColorParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setNSValueParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setNSValueParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setCIVectorParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setCIVectorParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setCIImageDataParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setCIImageDataParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setCIImageSourceParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setCIImageSourceParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setCIImageCubeDataParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setCIImageCubeDataParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setCIImageCubeDataParameterChannel.setMessageHandler { message, reply in
        ...
        let keyArg = args[1] as! String
        let dataArg = args[2] as! FlutterStandardTypedData
        let sizeArg = args[3] as! Int64
        let columnsArg = args[4] as! Int64
        let rowsArg = args[5] as! Int64
        do {
    ...
    let setCIImageCubeSourceParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setCIImageCubeSourceParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
      setCIImageCubeSourceParameterChannel.setMessageHandler { message, reply in
        ...
        let assetArg = args[2] as! Bool
        let pathArg = args[3] as! String
        let sizeArg = args[4] as! Int64
        let columnsArg = args[5] as! Int64
        let rowsArg = args[6] as! Int64
        do {
    ...
    let setNSDataParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setNSDataParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setNSDataSourceParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setNSDataSourceParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let setNSStringParameterChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.setNSStringParameter\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let disposeChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_core_image_filters.FilterApi.dispose\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
