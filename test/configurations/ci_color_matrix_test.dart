...
void main() {
  ...
  group('CIColorMatrix', () {
    test('change inputGVector', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputGVector')
    ...
    test('change inputRVector', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputRVector')
              as CIVectorParameter;
    ...
    test('change inputAVector', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputAVector')
              as CIVectorParameter;
    ...
    test('change inputBVector', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputBVector')
              as CIVectorParameter;
