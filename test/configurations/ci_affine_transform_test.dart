...
void main() {
  late CIAffineTransformConfiguration configuration;
  setUp(() {
    configuration = CIAffineTransformConfiguration();
  });
  group('CIAffineTransform', () {
    test('verify name', () {
      expect(configuration.name, 'CIAffineTransform');
    });
