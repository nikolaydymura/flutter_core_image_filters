...
void main() {
  late CIOpTileConfiguration configuration;
  setUp(() {
    configuration = CIOpTileConfiguration();
  });
  group('CIOpTile', skip: true, () {
    test('verify name', () {
      expect(configuration.name, 'CIOpTile');
    });
