...
void main() {
  ...
  group('CISpotColor', () {
    ...
    test('change inputContrast1', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputContrast1')
              as NumberParameter;
    ...
    test('change inputReplacementColor2', () {
      final parameter =
          configuration.parameters.firstWhere(
                (e) => e.name == 'inputReplacementColor2',
              )
              as ColorParameter;
    ...
    test('change inputContrast3', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputContrast3')
              as NumberParameter;
    ...
    test('change inputContrast2', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputContrast2')
              as NumberParameter;
      expect(parameter.value, 0.98);
    ...
    test('change inputReplacementColor1', () {
      final parameter =
          configuration.parameters.firstWhere(
                (e) => e.name == 'inputReplacementColor1',
              )
              as ColorParameter;
    ...
    test('change inputReplacementColor3', () {
      final parameter =
          configuration.parameters.firstWhere(
                (e) => e.name == 'inputReplacementColor3',
              )
              as ColorParameter;
