...
void main() {
  ...
  group('CIDepthBlurEffect', () {
    ...
    test('change inputLeftEyePositions', () {
      final parameter =
          configuration.parameters.firstWhere(
                (e) => e.name == 'inputLeftEyePositions',
              )
              as CGPositionParameter;
      expect(parameter.value, const Point(-1.0, -1.0));
    ...
    test('change inputShape', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputShape')
              as StringParameter;
    ...
    test('change inputRightEyePositions', () {
      final parameter =
          configuration.parameters.firstWhere(
                (e) => e.name == 'inputRightEyePositions',
              )
              as CGPositionParameter;
      expect(parameter.value, const Point(-1.0, -1.0));
    ...
    test('change inputAperture', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputAperture')
              as NumberParameter;
      expect(parameter.value, 0);
    ...
    test('change inputFocusRect', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputFocusRect')
              as CGRectParameter;
      expect(parameter.value, const Rect.fromLTWH(0.0, 0.0, 0.0, 0.0));
