...
void main() {
  late CIAreaMinMaxRedConfiguration configuration;
  setUp(() {
    configuration = CIAreaMinMaxRedConfiguration();
  });
  group('CIAreaMinMaxRed', () {
    test('verify name', () {
      expect(configuration.name, 'CIAreaMinMaxRed');
    });
