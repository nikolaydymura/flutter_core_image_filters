...
void main() {
  ...
  group('CIToneCurve', () {
    test('change inputPoint0', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputPoint0')
              as PointParameter;
    ...
    test('change inputPoint1', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputPoint1')
              as PointParameter;
    ...
    test('change inputPoint2', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputPoint2')
              as PointParameter;
      expect(parameter.value, const Point(0.5, 0.5));
    ...
    test('change inputPoint3', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputPoint3')
              as PointParameter;
    ...
    test('change inputPoint4', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputPoint4')
              as PointParameter;
