...
void main() {
  ...
  group('CISpotLight', () {
    test('verify name', () {
      expect(configuration.name, 'CISpotLight');
    });
    testInputKeys(build: () => configuration);
    test('change inputLightPointsAt', () {
      final parameter = configuration.parameters
          .firstWhere((e) => e.name == 'inputLightPointsAt') as VectorParameter;
    ...
    test('change inputConcentration', () {
      final parameter = configuration.parameters
          .firstWhere((e) => e.name == 'inputConcentration') as NumberParameter;
    ...
    test('change inputLightPosition', () {
      final parameter = configuration.parameters
          .firstWhere((e) => e.name == 'inputLightPosition') as VectorParameter;
