...
void main() {
  ...
  group('CITriangleKaleidoscope', () {
    test('change inputDecay', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputDecay')
              as NumberParameter;
    ...
    test('change inputPoint', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputPoint')
    ...
    test('change inputSize', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputSize')
              as NumberParameter;
