...
void main() {
  ...
  group('CILenticularHaloGenerator', () {
    ...
    test('change inputStriationContrast', () {
      final parameter =
          configuration.parameters.firstWhere(
                (e) => e.name == 'inputStriationContrast',
              )
              as NumberParameter;
    ...
    test('change inputStriationStrength', () {
      final parameter =
          configuration.parameters.firstWhere(
                (e) => e.name == 'inputStriationStrength',
              )
              as NumberParameter;
      expect(parameter.value, 0.5);
    ...
    test('change inputHaloWidth', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputHaloWidth')
              as NumberParameter;
