...
void main() {
  late CIConvolution9VerticalConfiguration configuration;
  setUp(() {
    configuration = CIConvolution9VerticalConfiguration();
  });
  group('CIConvolution9Vertical', () {
    test('verify name', () {
      expect(configuration.name, 'CIConvolution9Vertical');
    });
