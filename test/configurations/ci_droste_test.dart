...
void main() {
  ...
  group('CIDroste', () {
    ...
    test('change inputStrands', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputStrands')
              as NumberParameter;
    ...
    test('change inputZoom', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputZoom')
              as NumberParameter;
    ...
    test('change inputRotation', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputRotation')
              as NumberParameter;
      expect(parameter.value, 0);
