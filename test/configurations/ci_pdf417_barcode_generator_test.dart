...
void main() {
  ...
  group('CIPDF417BarcodeGenerator', () {
    ...
    test('change inputAlwaysSpecifyCompaction', () {
      final parameter =
          configuration.parameters.firstWhere(
                (e) => e.name == 'inputAlwaysSpecifyCompaction',
              )
              as BoolParameter;
    ...
    test('change inputRows', () {
      final parameter =
          configuration.parameters.firstWhere((e) => e.name == 'inputRows')
              as NumberParameter;
      expect(parameter.value.isNaN, true);
    ...
    test('change inputPreferredAspectRatio', () {
      final parameter =
          configuration.parameters.firstWhere(
                (e) => e.name == 'inputPreferredAspectRatio',
              )
              as NumberParameter;
      expect(parameter.value.isNaN, true);
