...
void main() {
  for (final displayName in FlutterCoreImageFilters.availableFilters) {
    ...
    test('default bool values of `$displayName`', () {
    ...
    test('default number values of `$displayName`', () {
    ...
    test('default point values of `$displayName`', () {
      final paramValues = kDefaultValues[configuration.name];
      expect(paramValues, isNotNull);
      final pointParams = configuration.parameters.whereType<PointParameter>();
    ...
    test('default rect values of `$displayName`', () {
      final paramValues = kDefaultValues[configuration.name];
      expect(paramValues, isNotNull);
    ...
    test('default vector values of `$displayName`', () {
      final paramValues = kDefaultValues[configuration.name];
      expect(paramValues, isNotNull);
      final vectorParams = configuration.parameters.whereType<ListParameter>();
