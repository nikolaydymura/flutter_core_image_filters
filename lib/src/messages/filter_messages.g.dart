...
class FilterApi {
  ...
  Future<void> exportVideoFile(int arg_filterId, bool arg_asset, String arg_input, String arg_output, String arg_format, String arg_context, String arg_preset) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.FilterApi.exportVideoFile', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_filterId, arg_asset, arg_input, arg_output, arg_format, arg_context, arg_preset]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
